...
# --- Nút bấm ---
btn1 = tk.Button(window, text="quét xe vào", command=partial(run_file, "xeVao.py"), width=25, height=2)
btn2 = tk.Button(window, text="Quét xe ra", command=partial(run_file, "xeRa.py"), width=25, height=2)
